 ...
 *         (*) Not on all G4 devices
 */
__STATIC_INLINE uint32_t LL_DMAMUX_GetRequestID(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 */
__STATIC_INLINE uint32_t LL_DMAMUX_GetSyncRequestNb(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                    uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 *         @arg @ref LL_DMAMUX_SYNC_POL_RISING_FALLING
 */
__STATIC_INLINE uint32_t LL_DMAMUX_GetSyncPolarity(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                   uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMAMUX_EnableEventGeneration(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                     uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMAMUX_DisableEventGeneration(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                      uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 */
__STATIC_INLINE uint32_t LL_DMAMUX_IsEnabledEventGeneration(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                            uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DMAMUX_IsEnabledSync(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                 uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMAMUX_SetSyncID(const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel,
                                         uint32_t SyncID)
{
    (void) (DMAMUXx);
 ...
 *         @arg @ref LL_DMAMUX_SYNC_LPTIM1_OUT
 */
__STATIC_INLINE uint32_t LL_DMAMUX_GetSyncID(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                             uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMAMUX_EnableRequestGen(const DMAMUX_Channel_TypeDef *DMAMUXx,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMAMUX_DisableRequestGen(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                 uint32_t                      RequestGenChannel)
{
    (void) (DMAMUXx);
    CLEAR_BIT(
...
{
    UNUSED(DMAMUXx);
    return ((READ_BIT(DMAMUX1_ChannelStatus->CSR, DMAMUX_CSR_SOF14) == (DMAMUX_CSR_SOF14)) ? 1UL
                                                                                           : 0UL);
}
...
{
    UNUSED(DMAMUXx);
    return ((READ_BIT(DMAMUX1_ChannelStatus->CSR, DMAMUX_CSR_SOF15) == (DMAMUX_CSR_SOF15)) ? 1UL
                                                                                           : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_DMAMUX_IsEnabledIT_SO(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                                  uint32_t                      Channel)
{
    (void) (DMAMUXx);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMAMUX_EnableIT_RGO(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                            uint32_t                      RequestGenChannel)
{
    UNUSED(DMAMUXx);
    SET_BIT(((DMAMUX_RequestGen_TypeDef *) ((uint32_t) ((uint32_t) DMAMUX1_RequestGenerator0 +
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMAMUX_DisableIT_RGO(const DMAMUX_Channel_TypeDef *DMAMUXx,
                                             uint32_t                      RequestGenChannel)
{
    UNUSED(DMAMUXx);
    CLEAR_BIT(
