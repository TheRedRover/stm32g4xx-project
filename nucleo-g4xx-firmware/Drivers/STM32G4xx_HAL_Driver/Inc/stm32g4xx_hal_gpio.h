...
#define GPIO_SPEED_FREQ_MEDIUM                                                                     \
    (0x00000001U) /*!< range  5 MHz to 25 MHz, please refer to the product datasheet */
#define GPIO_SPEED_FREQ_HIGH                                                                       \
    (0x00000002U) /*!< range 25 MHz to 50 MHz, please refer to the product datasheet */
#define GPIO_SPEED_FREQ_VERY_HIGH                                                                  \
    (0x00000003U) /*!< range 50 MHz to 120 MHz, please refer to the product datasheet */
/**
 * @}
 */
