...
#define STM32G4XX_NUCLEO_BSP_VERSION_SUB2 0x06U /*!< [15:8]  sub2 version */
#define STM32G4XX_NUCLEO_BSP_VERSION_RC 0x00U   /*!< [7:0]  release candidate */
#define STM32G4XX_NUCLEO_BSP_VERSION                                                               \
    ((STM32G4XX_NUCLEO_BSP_VERSION_MAIN << 24) | (STM32G4XX_NUCLEO_BSP_VERSION_SUB1 << 16) |       \
     (STM32G4XX_NUCLEO_BSP_VERSION_SUB2 << 8) | (STM32G4XX_NUCLEO_BSP_VERSION_RC))
