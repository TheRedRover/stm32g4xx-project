...
#define PWR_PORTG_AVAILABLE_PINS 0x000007FFU /* PG0..PG10 */
    ...
    defined(STM32G441xx) || defined(STM32GBK1CB) || defined(STM32G491xx) || defined(STM32G4A1xx)
 ...
 * range 1 boost mode, typical output voltage at 1.28 V, system frequency up to 170 MHz.
