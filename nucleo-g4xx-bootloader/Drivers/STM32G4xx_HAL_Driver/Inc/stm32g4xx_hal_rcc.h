...
typedef struct
{
    ...
    uint32_t PLLR; /*!< PLLR: Division for the main system clock.
                      ...
                      170MHZ. This parameter must be a value of @ref RCC_PLLR_Clock_Divider */
 ...
 * @note   Enabling/disabling clock outputs RCC_PLL_ADCCLK and RCC_PLL_48M1CLK can be done at
 ...
 *            @arg @ref RCC_PLL_48M1CLK  This Clock is used to generate the clock for the USB (48
 * MHz), FDCAN (<=48 MHz) and QSPI (<=48 MHz).
...
#define IS_RCC_PLLSOURCE(__SOURCE__)                                                               \
    (((__SOURCE__) == RCC_PLLSOURCE_NONE) || ((__SOURCE__) == RCC_PLLSOURCE_HSI) ||                \
